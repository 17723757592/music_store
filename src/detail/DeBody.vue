    ...
    <div class="g-main">
        <div class="n-detail">
                    ...
                    <div class="smallnav">
                        <ul>
                            <li v-for="(item,index) in goods.detailnav" :key="index">
                                <img :src="item" alt="" @click="changeShow(item,index)">
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="basic">
                        ...
                        <div class="standard">
                            <div class="select-box">
                                ...
                                <ul>
                                    <li v-for="(standard,index) in goods.standard" :key="index" >
                                        <p>{{ standard }}</p>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="n-contend">
                <div class="n-contend-left">
                    ...
                    <div class="n-describe">
                        <div class="j-flag">
                           <img v-for="(item,index) in goods.detailimg" :key="index" :src="item" alt="">
                            <p v-for="(item,index) in goods.detailtxt" :key="index">{{ item }}</p>
                            <p><br></p>
                            <p><span>购买须知</span></p>
            ...
            <div ref="topbar" class="topbar" v-show="isVisable">
                <div class="barbox">
                    <div class="imgbox"><img :src="goods.detailnav[0]" alt=""></div>
                    <div class="barmsg">
                        <p>{{ titleR }}</p>
                        <span :style="{color:'#d33a31'}">{{goods.price}}</span>
                    </div>
...
export default {    
    ...
    created(){
        ...
        this.showImg = this.goods.detailnav[0]
